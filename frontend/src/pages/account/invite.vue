  ...
  <div>
    <t-card>
      ...
      >
        ...
        <t-form-item label="Exp. Date" name="expires_time">
          <t-select v-model="inviteUser.expires_time" :options="ExpiresAtList" placeholder="Exp. Date"></t-select>
        </t-form-item>
        <t-form-item label="Number of invitation" name="invite_count">
...
const columns: TableProps['columns'] = [
  ...
  { colKey: 'invite_count', title: 'Number of invitations' },
  { colKey: 'used_count', title: 'Usage' },
  { colKey: 'expires_at', title: 'Expiration time', width: 200 },
  { colKey: 'invite_url', title: 'Invite Link', width: 300 },
